<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProcessLead.aspx.cs" Inherits="ProcessLead"
    Buffer="false" %>
...
<body>
    ...
    <input type="hidden" name="hdnEmail" id="hdnEmail" value="<%= strEmail %>" />
    ...
    <div id="dvForm" class="WidgetContainer" runat="server">
        <div class="WidgetHeader">
            <div class="MessageBox">
                <div class="ImageBox" runat="server" id="imgPicture">
                    <img src="<%= CustomerSupport.Utility.SysResource.HomePath %>userimages/<%= strImageFileName %>"
                        border="0" />
                </div>
                <div id="lblHeader">
                    <%= strHeader %>
        ...
        <div class="ElementLabel">
            <asp:Label ID="lblMsg" runat="server" CssClass="Required" Visible="false"></asp:Label></div>
        <div class="WidgetMiddle">
            ...
            <div style="width: 120px; float: left; padding-top: 5px; padding-left: 5px; height: 35px;
                ...
                <div id="SecureInfo" style="display: none; position: absolute; color: black;" class="SecureInfoText">
                    ...
                    be able to see your email/phone. They may contact you securely via delightDesk.
    ...
    <script type="text/javascript">
        try {
            var pageTracker = _gat._getTracker("UA-1390565-2");
