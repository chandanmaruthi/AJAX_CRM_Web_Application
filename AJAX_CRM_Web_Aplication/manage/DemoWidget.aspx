<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DemoWidget.aspx.cs" Inherits="Widget" %>
...
<head runat="server">
    ...
    .WidgetHeader
    {
        ...
        height: 55px; 
        padding: 0px; 
        /*background-image: url('<%= CustomerSupport.Utility.SysResource.ImagePath %>WidgetLayout/WidgetHeader_1.gif');-*/
        background-repeat:no-repeat;
        display:block;
        float:left;
        color:<%= strTitleColor %>;
    ...
    {
        width: 136px; 
        /*background-image: url('<%= CustomerSupport.Utility.SysResource.ImagePath %>WidgetLayout/WidgetMiddle_1.gif');*/
    ...
    .WidgetFooter
    {
        ...
        height: 1px; 
        padding: 0px; 
        /*background-image: url('<%= CustomerSupport.Utility.SysResource.ImagePath %>WidgetLayout/WidgetFooter_1.gif');*/
        display:block;
        float:left;
    }
    .SecureInfoText
        ...
        <div id="dvForm" class="WidgetContainer" runat="server">
            ...
            <div class="WidgetMiddle">
                ...
                <div class="ElementInput">
                    <textarea id="txtComments" style="width: 120px; height: 40px"></textarea>
                </div>
                <div class="ElementInput">
                    <input class="InputSections" type="text"  runat="server" id="txtName"
                        value="Name" maxlength="75" onfocus="javascript:SetFocusTextBox('txtName', 'Name');return false;"
                        onblur="javascript:LoseFocusTextBox('txtName', 'Name');return false;" /></div>
                <div class="ElementInput">
                    <input class="InputSections" type="text"  runat="server" id="txtEmail"
                        value="Email" maxlength="75" onfocus="javascript:SetFocusTextBox('txtEmail', 'Email');return false;"
                        onblur="javascript:LoseFocusTextBox('txtEmail', 'Email');return false;" /></div>
                <div class="ElementInput">
                    <input class="InputSections" type="text"  runat="server" id="txtPhone"
                        value="Phone" maxlength="75" onfocus="javascript:SetFocusTextBox('txtPhone', 'Phone');return false;"
                ...
                <div style="width: 120px; float: left; padding-top: 5px; padding-left: 5px; height: 35px;
                    overflow: hidden;">
                    <input type="checkbox" id="chkHideEmail" runat="server" style="vertical-align: middle;border:0px;" />
                    ...
                    <div id="SecureInfo" style="display: none; position: absolute;color:black;" class="SecureInfoText">
                        Check this box to interact securely via CustomerSupport. The reciepient will not be able
                        to see your email/phone. They may contact you securely via delightDesk.
                        <a href="#" onclick ="javascript:document.getElementById('SecureInfo').style.display='none';"> Close X </a>
                    </div>
                </div>
            ...
            powered by <a href="http://www.CustomerSupport.com" target="_blank">CustomerSupport</a></div>
