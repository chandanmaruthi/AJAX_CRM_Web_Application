<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SC_HandleConversation.aspx.cs"
    Inherits="Partials_SC_HandleConversation" %>
                ...
                <div class="HotTopics">
                    <div class="PictureBox">
                        ...
                        <div class="ProfileText">
                            <%# Eval("User_Name") %>
                            <%# Eval("Official").ToString() == "True" ? "<div stlye=\"background-color:green;color:white;\"> <b>Official</b></div>" : ""%>
                        </div>
                    </div>
