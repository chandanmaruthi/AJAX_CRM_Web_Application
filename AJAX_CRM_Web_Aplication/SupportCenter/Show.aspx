<%@ Page Title="" Language="C#" MasterPageFile="~/SupportCenter/SupportCenterMaster.master" Buffer="false"  AutoEventWireup="true"
    CodeFile="Show.aspx.cs" Inherits="manage_Show" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
 ...
 <%--<%= strStatusName %> Conversations for  under <%= strCategoryName %> category and under <%= strTagName %> tag--%></span>
    ...
    <div style="height:20px;float:left;width:750px;margin-bottom:10px;margin-top:5px;">
<span style="font-family:Georgia,Arial;color:#404040;font-size:18px;"><%= strProductName %>
 </div>
